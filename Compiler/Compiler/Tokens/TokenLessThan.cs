...
namespace AocIntComputer.Compiler.Tokens {
    public class TokenLessThan : InstructionToken {
        public override string TokenValue => "LT";
        ...
        public override long[] Compile(params ParameterToken[] parameters) {
            ...
            compiled[0] = BaseIntComputer.OpCodeLessThan + EncodeParameterModes(parameters);
